...
class MainViewModel(
    ...
    private suspend fun initializeModel() {
        try {
            ...
            _isModelReady.value = modelFound
            ...
            if (modelFound) {
                ...
                val systemMessage = ChatMessage(
                    ...
                    content = "✅ Model loaded: ${_modelName.value}",
                    isUser = false
                )
    ...
    fun sendMessage(content: String) {
        viewModelScope.launch {
            ...
            try {
                // Simple response for now - MediaPipe implementation will be added
                val response = if (_isModelReady.value) {
                    "Model is ready. Response will be generated by MediaPipe."
                } else {
